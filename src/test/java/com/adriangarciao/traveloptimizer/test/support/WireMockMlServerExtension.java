...
/**
 * JUnit 5 extension that starts a WireMockServer on a dynamic port and registers basic ML stubs
...
public class WireMockMlServerExtension implements BeforeAllCallback, AfterAllCallback {
    ...
    public void beforeAll(ExtensionContext context) throws Exception {
        ...
        this.server.stubFor(
                post(urlEqualTo("/predict/best-date-window"))
                        .willReturn(
                                aResponse()
        ...
        this.server.stubFor(
                post(urlEqualTo("/predict/option-recommendation"))
                        .willReturn(
                                aResponse()
                                        .withHeader("Content-Type", "application/json")
                                        .withBody(
