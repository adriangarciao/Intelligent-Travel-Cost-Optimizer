...
class TripSearchControllerTest {
    ...
    void controller_returnsServiceResponse_directCall() {
        ...
        TripSearchResponseDTO resp =
                TripSearchResponseDTO.builder()
                        ...
                        .mlBestDateWindow(
                                new MlBestDateWindowDTO(
                                        LocalDate.now(), LocalDate.now().plusDays(3), 0.5))
                        .build();
        ...
        com.adriangarciao.traveloptimizer.repository.TripSearchRepository repo =
                Mockito.mock(
                        com.adriangarciao.traveloptimizer.repository.TripSearchRepository.class);
