...
public class WebClientMlClientTest {
    ...
    public void stub500ForOptionRecommendation() {
        WMEXT.getServer()
                .stubFor(post(urlPathEqualTo("/predict")).willReturn(aResponse().withStatus(500)));
    }
    ...
    void mlClient_mapsResponses_and_fallsBack() {
        ...
        stubBestDateWindow(
                "{\"recommendedDepartureDate\":\"2025-12-20\",\"recommendedReturnDate\":\"2025-12-25\",\"confidence\":0.8}");
        ...
        MlRecommendationDTO rec =
                client.getOptionRecommendation(option, req, java.util.List.of(option));
        ...
        MlRecommendationDTO fallbackRec =
                client.getOptionRecommendation(option, req, java.util.List.of(option));
