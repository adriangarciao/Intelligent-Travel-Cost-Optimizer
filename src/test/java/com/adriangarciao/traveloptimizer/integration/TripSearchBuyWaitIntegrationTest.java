...
public class TripSearchBuyWaitIntegrationTest {
    ...
    static {
        ...
        wireMockServer.stubFor(com.github.tomakehurst.wiremock.client.WireMock.post(com.github.tomakehurst.wiremock.client.WireMock.urlEqualTo("/predict/option-recommendation"))
                .willReturn(com.github.tomakehurst.wiremock.client.WireMock.aResponse().withHeader("Content-Type", "application/json")
                        .withBody("{\"action\":\"BUY\",\"trend\":\"stable\",\"confidence\":0.55,\"reasons\":[\"mocked\"]}")
                        .withStatus(200)));
    }
    ...
    void searchEndpoint_includesBuyWaitOnOptions() throws Exception {
        ...
        TripSearchResponseDTO body = mapper.readValue(mvcResult.getResponse().getContentAsString(), TripSearchResponseDTO.class);
        assertThat(body).isNotNull();
        assertThat(body.getOptions()).isNotEmpty();
        body.getOptions().forEach(opt -> {
