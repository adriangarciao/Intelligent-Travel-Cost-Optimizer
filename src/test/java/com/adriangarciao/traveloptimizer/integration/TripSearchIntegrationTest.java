    ...
    void searchEndpoint_returnsOkAndPayload() throws Exception {
        ...
        if ("true".equalsIgnoreCase(useTc)) {
            try {
                ...
                log.warn(
                        "Redis connectivity check failed with exception — continuing without Redis: {}",
                        t.toString());
            }
        }
        ...
        var mvcResult1 =
                mockMvc.perform(
                        ...
                        .andReturn();
        TripSearchResponseDTO body1 =
                mapper.readValue(
                        mvcResult1.getResponse().getContentAsString(), TripSearchResponseDTO.class);
        ...
        var mvcResult2 =
                mockMvc.perform(
                        ...
                        .andExpect(status().is2xxSuccessful())
                        .andReturn();
        TripSearchResponseDTO body2 =
                mapper.readValue(
                        mvcResult2.getResponse().getContentAsString(), TripSearchResponseDTO.class);
