...
public class TripSearchAmadeusIntegrationTest {
    ...
    @RegisterExtension static WireMockMlServerExtension registeredWireMock = WMEXT;
                ...
                post(urlEqualTo("/v1/security/oauth2/token"))
                        .willReturn(
                                aResponse()
                                        ...
                                        .withBody(
                                                "{\"access_token\":\"int-test-token\",\"expires_in\":1799,\"token_type\":\"Bearer\"}")
                                        .withStatus(200)));

        // offers stub using fixture
        String fixture =
                TripSearchAmadeusIntegrationTest.class.getResourceAsStream(
                                        "/fixtures/amadeus_offers_2.json")
                                != null
                        ? new String(
                                TripSearchAmadeusIntegrationTest.class
                                        .getResourceAsStream("/fixtures/amadeus_offers_2.json")
                                        .readAllBytes())
                        : "{}";
        wm.stubFor(
