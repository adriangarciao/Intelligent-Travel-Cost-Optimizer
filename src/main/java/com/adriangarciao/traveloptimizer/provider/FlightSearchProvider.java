...
public interface FlightSearchProvider {
    ...
    /**
     * Fetch flight offers with a specific limit for progressive pagination.
     * Unlike searchFlights(), this method bypasses caching to get fresh results.
     * 
     ...
     */
    default FlightSearchResult searchFlightsWithLimit(TripSearchRequestDTO request, int maxResults) {
