...
/**
 * Entity to store price observations for route/date combinations.
 * Used for computing price trends over time.
 */
@Entity
@Table(name = "price_observation", indexes = {
    @Index(name = "idx_price_obs_route", columnList = "origin, destination, departure_date"),
